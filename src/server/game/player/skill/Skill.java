...
public final class Skill {
    ...
    /**
     * Sets the level to the argued value.
     * 
     * @param level
     * 			The amount to set the level to.
     */
    ...
    public void setExperience(double experience) {
    	this.experience = Math.min(experience, MAX_EXPERIENCE);
    }

    /**
     * Adds an amount of experience to {@link Skill#experience)
     * 
     * @param amount
     * 			The amount to add.
     */
    public void addExperience(double amount) {
    	this.experience = Math.min(200_000_000, experience + amount);
    }
    ...
    /**
     * <b>CAUTION:</b> This method will set the real level, and experience!!
     * Accidental use of this method could result in unwanted loss or increase of levels.
     * 
     * @param level
     * 			The amount to set the new level and respective experience amount to.
     * @param refresh
     * 			true if you want the {@link Skill#level} to be set to.
     */
    public void setRealLevelAndExperience(int level, boolean refresh) {
    	setRealLevel(level);
    	setExperience(ExperienceTable.get(level));
    	if (refresh) {
    		setLevel(level);
    	}
    }
